...
namespace FrameworkSetup.Pages
{
    class LogoutPage
    {
        ...
        /// <summary>
        /// Logout from application for a test step.
        /// </summary>
        /// <param name="inputjson"></param>
        /// <returns></returns>
        public List<TestReportSteps> LogoutApplication(JToken inputjson)
        {
            var listReport = ConfigFile.GetReportFile("AddLogoutInLoginHistory.json");
            var stepCount = 0;
            try
            {
                //Click profile button
