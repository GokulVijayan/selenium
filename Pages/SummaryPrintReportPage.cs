    ...
    class SummaryPrintReportPage
    {
        ...
        public List<TestReportSteps> VerifySummaryPrintReportExportToExcel()
        {
            ...
            try
            {
                ...
                var path = System.Environment.GetEnvironmentVariable("USERPROFILE") + "\\Downloads";
                var directory = new DirectoryInfo(path);
                var myFile = directory.GetFiles().OrderByDescending(f => f.LastWriteTime).First();


                bool reportExportStatus = CheckFileDownloaded(myFile.ToString());
                if (reportExportStatus == true && Path.GetExtension(myFile.ToString()).Contains(".xlsx"))
                    listOfReport[step++].SetActualResultFail("");
        ...
        public List<TestReportSteps> VerifySummaryPrintReportExportToPDF()
        {
            ...
            try
            {
                ...
                bool reportExportStatus = CheckFileDownloaded(myFile.ToString());
                if (reportExportStatus == true && Path.GetExtension(myFile.ToString()).Contains(".pdf"))
                    listOfReport[step++].SetActualResultFail("");
        ...
        public List<TestReportSteps> VerifySummaryPrintReportExportToWord()
        {
            ...
            try
            {
                ...
                bool reportExportStatus = CheckFileDownloaded(myFile.ToString());
                if (reportExportStatus == true && Path.GetExtension(myFile.ToString()).Contains(".docx"))
                    listOfReport[step++].SetActualResultFail("");
        ...
        public List<TestReportSteps> VerifySummaryPrintReportExportToHTML()
        {
            ...
            try
            {
                ...
                bool reportExportStatus = CheckFileDownloaded(myFile.ToString());
                if (reportExportStatus == true && Path.GetExtension(myFile.ToString()).Contains(".html"))
                    listOfReport[step++].SetActualResultFail("");
        ...
        public List<TestReportSteps> VerifySummaryPrintReportExportToDocument()
        {
            ...
            try
            {
                ...
                bool reportExportStatus = CheckFileDownloaded(myFile.ToString());
                if (reportExportStatus == true && Path.GetExtension(myFile.ToString()).Contains(".mdc"))
                    listOfReport[step++].SetActualResultFail("");
        ...
        public List<TestReportSteps> VerifySummaryPrintReportExportToDataFile()
        {
            ...
            try
            {
                ...
                bool reportExportStatus = CheckFileDownloaded(myFile.ToString());
                if (reportExportStatus == true && Path.GetExtension(myFile.ToString()).Contains(".csv"))
                    listOfReport[step++].SetActualResultFail("");
