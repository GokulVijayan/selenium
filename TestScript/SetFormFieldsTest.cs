...
/*
 ...
 Test Case Automated 		:Vehicle can be deleted form a Crash record only when there is more than 1 vehicle
 Test Objective         :To verify that a Vehicle can be deleted form a Crash record only when there is more than 1 vehicle.
 Author 				:Experion
 Script Name 			:TS001_iMAAP_Web_Delete vehicle from crash record verification
 Script Created on 		:10/08/2019
 #######################################################################
*/
...
namespace FrameworkSetup.TestScript
{
    ...
    class SetFormFieldsTest
    {
        ...
        public void AddAndDeleteVehicle()
        {
